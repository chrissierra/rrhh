          ...
          <div class="nav_menu">
            <nav>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="./index.php" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    ...
                    <li>
                     ...
                     echo '<a href="ingreso_clientes.php"><span class="badge bg-red pull-right">50%</span>
                        <span>'. 'Ingreso Clientes' .'</span>';   
                      }else{
                        echo ' <a href="javascript:;"> <span class="badge bg-red pull-right">50%</span>
                        <span>Settings</span>';
                      }
